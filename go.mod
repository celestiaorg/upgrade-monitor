module github.com/celestiaorg/upgrade-monitor
...
replace (
	github.com/celestiaorg/celestia-app => github.com/celestiaorg/celestia-app v0.0.0-20231213004739-e0edb4cf0d89
